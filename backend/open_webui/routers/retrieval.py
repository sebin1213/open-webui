...
async def get_rag_config(request: Request, user=Depends(get_admin_user)):
    return {
        ...
        "EXTERNAL_DOCUMENT_LOADER_ENABLE_PDF_CONVERSION": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_ENABLE_PDF_CONVERSION,
        "EXTERNAL_DOCUMENT_LOADER_GOTENBERG_URL": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_GOTENBERG_URL,
